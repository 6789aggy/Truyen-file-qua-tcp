...
public class ClientB extends JFrame {
    ...
    private final File saveDir = new File("Files_ClientB");
    ...
    private void sendFile() {
        ...
        try (FileInputStream fis = new FileInputStream(selectedFile)) {
            ...
            dos.flush();
            log("Đã gửi file: " + selectedFile.getName() + "đến Clinet A");
        } catch (IOException e) {
    ...
    private void listenForFiles() {
        try {
            while (true) {
                ...
                log("Đã nhận file từ Client A: " + fileName +
                    " (" + fileSize + " bytes ~ " +
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new ClientB().setVisible(true));
    }
}
